...
export default function CursosLanding() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section id="temario" className="py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto">
              5 módulos especializados diseñados por expertos para transformar tu conocimiento en ganadería regenerativa
            </p>
          </div>
            ...
            <Card className="group hover:shadow-2xl transition-all duration-300 border-l-4 border-l-accent bg-gradient-card">
              <CardHeader className="bg-accent text-accent-foreground rounded-t-lg">
                <CardTitle className="flex items-center gap-3 text-xl">
                  ...
                  Mejoramiento Genético Holístico y Búfalos de Agua en Sistemas Regenerativos
                </CardTitle>
              </CardHeader>
              <CardContent className="p-6 space-y-6">
                <div className="space-y-4">
      ...
      {/* ========== INICIO: SECCIÓN UNIFICADA DE INFORMACIÓN DEL CURSO ========== */}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-5xl mx-auto bg-background rounded-2xl shadow-2xl border-2 border-primary/20 overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              {/* Columna de la Izquierda: Qué incluye */}
              ...
              {/* Columna de la Derecha: Precio y CTA */}
      ...
      {/* ========== FIN: SECCIÓN UNIFICADA DE INFORMACIÓN DEL CURSO ========== */}
