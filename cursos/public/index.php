...
<body>
        ...
        <div class="course-card">
            ...
            <div class="course-content">
                ...
                <?php elseif ($isLoggedIn): ?>
                    ...
                    <div id="paypal-container-<?= escape($config['paypal']['hosted_button_id']) ?>"></div>
            ...
            <div class="course-info-content">
                <div class="course-info-grid">
                    ...
                    <div class="course-info-right">
                        ...
                        <?php elseif ($isLoggedIn): ?>
                            <div id="paypal-container-<?= escape($config['paypal']['hosted_button_id']) ?>-2"></div>
                        <?php else: ?>
    ...
    <!-- PayPal Hosted Button Script -->
    <?php if ($isLoggedIn && !$hasAccess): ?>
    <script 
        src="https://www.paypal.com/sdk/js?client-id=<?= escape($config['paypal']['client_id']) ?>&components=hosted-buttons&disable-funding=venmo&currency=MXN"
        nonce="<?= getNonce() ?>">
    </script>
    <script nonce="<?= getNonce() ?>">
        // Renderizar botón hosted en la primera ubicación
        paypal.HostedButtons({
            hostedButtonId: "<?= escape($config['paypal']['hosted_button_id']) ?>",
        }).render("#paypal-container-<?= escape($config['paypal']['hosted_button_id']) ?>");
        
        // Renderizar botón hosted en la segunda ubicación
        paypal.HostedButtons({
            hostedButtonId: "<?= escape($config['paypal']['hosted_button_id']) ?>",
        }).render("#paypal-container-<?= escape($config['paypal']['hosted_button_id']) ?>-2");
    </script>
    <?php endif; ?>
</body>
</html>