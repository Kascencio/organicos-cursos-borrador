                ...
                <div class="settings-container">
                    ...
                    <div class="settings-section">
                        ...
                        <div class="section-content">
                            ...
                            <div class="form-group">
                                <label class="form-label">ID del Botón Hosted</label>
                                <input type="text" name="config[paypal_hosted_button_id]" class="form-input" 
                                       value="<?= escape($config['paypal_hosted_button_id'] ?? '') ?>">
                                <div class="form-help">ID del botón hosted de PayPal</div>
                            </div>
                        </div>
                    </div>
